...
{
    /*
     * Every frame takes the two textures that make up video ARKit wants to display from camera
     * and uses YUVMaterial shader to combine them into background rendered by camera
     */
